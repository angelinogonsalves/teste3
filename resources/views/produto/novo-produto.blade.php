            ...
            <div class="row col-md-12">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="produto" class="form-control" placeholder="Escreva nome do produto" value="{{ old('produto', $dados->produto) }}">
                    </div>
                </div>
                <div class="col-sm-7">
                    <!-- text input -->
                ...
                <div class="col-sm-5">
                    <div class="form-group">
                        ...
                        <div class="select2-purple">
                            <select name="tamanhos[]" class="selectpicker bs-select form-control" multiple="" data-live-search="true" data-placeholder="Selecione ">
                                @forelse ($lista_tamanhos as $t)
                                <option value="{{ $t->id }}" @if ($dados->tamanhos->find($t->id)) selected="" @endif> {{ $t->tamanho }}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="valor" id="valor_unitario" class="form-control" placeholder="Escreva valor 0,00" value="{{ number_format($dados->valor ?? old('valor'), 2, ',', '.') }}">
                    </div>
                </div>
                <div class="col-sm-9">
                    <div class="form-group">
                        ...
                        <div class="select2-purple">
                            <select name="unidades[]" class="selectpicker bs-select form-control" multiple="" data-live-search="true" data-placeholder="Selecione as  ">
                                @forelse ($lista_unidades as $u)
                                <option value="{{ $u->id }}" @if ($dados->unidades->find($u->id)) selected="" @endif> {{ $u->nome_fantasia }}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <label for="fu_imagem_principal">
                                    ...
                                    <input type="file" id="fu_imagem_principal" name="fu_imagem_principal" style="display:none" class="custom-file-input">
                                </label>
                            </div>
                                ...
                                @forelse ($dados->imagens as $i )    
                                    @if ($i->tipo == 'P')                                
                                        <div class="col-md-4 imgProduto">
                                            <div class="form-group">
                                                <img src="{{$i->url}}" class="img-thumbnail" id="img_produto" name="img_produto" data-nome="' . $name . '"/>                           
                                                <input type="hidden" name="foto_produto[]" value="{{$i->imagem}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <label for="fu_imagem_tamanhos">
                                    ...
                                    <input type="file" id="fu_imagem_tamanhos" name="fu_imagem_tamanhos" style="display:none" class="custom-file-input">
                                </label>
                            </div>
                                ...
                                @forelse ($dados->imagens as $i )    
                                    @if ($i->tipo == 'T')                                
                                        <div class="col-md-4 imgProduto">
                                            <div class="form-group">
                                                <img src="{{$i->url}}" class="img-thumbnail" id="img_produto" name="img_produto" data-nome="' . $name . '"/>                           
                                                <input type="hidden" name="foto_tamanho[]" value="{{$i->imagem}}">
                                                <div class="row text-center">
                                                    <div class="col-md-12">
                                                        <button class="btn btn-danger btnexcluiimagem" onclick="excluiimagem(this)"><i class="fas fa-times-circle"> </i>Remover</button>
                                                    </div>
