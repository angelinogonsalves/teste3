            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="/aluno/home" class="nav-link">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="http://www.razzaesportes.com.br" class="nav-link">Contato</a>
                        </li>
                        <li class="nav-item">
                            <a href="/aluno/detalhes-pedido" class="nav-link">Meus Pedidos</a>
                        </li>
